      ...
      <div class="col-md-8">
        <div class="card shadow-sm rounded-4">
          ...
          <div class="card-body">
            ...
            <p class="mb-1 text-muted"><i class="bi bi-clock text-danger"></i> <?= $jam ?></p>
            <p class="mb-3 text-muted"><i class="bi bi-geo-alt text-danger"></i> <?= $row['tempat'] ?></p>
          ...
          <div class="card-footer bg-white border-0 d-flex justify-content-between">
            ...
            <div class="btn-group">
              ...
              <a href="https://www.instagram.com/kkopaudsemarang" target="_blank" class="btn btn-danger"
